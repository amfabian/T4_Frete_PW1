...
<!-- Navegação !-->
    ...
    <%  
        List<Cliente> lista=clienteBean.listarTodos();  
		...
		<div class="container-fluid">
			...
			<div class="card mb-3">
				<div class="card-header">
					<i class="fa fa-table"></i> Clientes Cadastrados
				</div>
				<div class="card-body">
					     	...
					     	<c:forEach var="cliente" items="${listaReq}">
						    	<tr>
						    	   ...
						    	   <td>${cliente.getCpf()}</td>						   	   	   
						   	   	   <td><a href="editCliente.jsp?idCliente=${cliente.getIdCliente()}"> Editar </a></td>
						    	</tr>
  					       </c:forEach>
						</tbody>
					</table>
